...
2. **ocr-doc-{id}** → OCR ogni documento (Mistral OCR, parallelo per doc)
3. **classify-documents** → auto-classificazione documenti tipo "altro" (Mistral Small, step 2.5)
...
11. **generate-synthesis** → report con ruolo adattivo + RAG linee guida + calcoli (split mode per casi grandi >40K chars)

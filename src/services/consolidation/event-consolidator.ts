...
export function consolidateEvents(
  ...
  const dedupedSameDoc = foldPrescriptionsIntoVisit(foldPrognosisIntoCertificate(collapsePsEpisodes(dedupWithinSameDocument(reclassifyPricelessExpenseEvents(allEvents)))));

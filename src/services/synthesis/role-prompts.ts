...
Per ogni anomalia, menziona anche eventuali giustificazioni cliniche plausibili.`,
    anomalyFraming: `Per ogni anomalia usa questa struttura:
- RILIEVO: descrizione oggettiva del fatto
- POSSIBILE CRITICITÀ: come potrebbe configurarsi un profilo di responsabilità
- CONTRODEDUZIONI: possibili giustificazioni cliniche
- VALUTAZIONE: giudizio equilibrato`,
    extraSections: '',

...
- Ometti SOLO il rumore non clinico (intestazioni anagrafiche/amministrative RIPETUTE e a sé stanti, tabelle di triage, codici tariffari/ticket, diciture di stampa, timbri) e le categorie escluse più sotto. Segnala le omissioni interne a una citazione con l'ellissi: «... prima parte ... seconda parte ...».
- FEDELTÀ PRIMA DELLA SINTESI sui dati anagrafici: quando nome/data di nascita/residenza sono INTRECCIATI in una frase clinica (es. «Il Sig. Nome Cognome, nato a … il …, residente in …, in relazione all'incidente ha riportato …»), NON spezzarli lasciando frammenti grammaticali privi di valore come «Il Sig., nato a il,» o «residente in ,». Due sole opzioni ammesse: (a) riproduci la frase PER INTERO e verbatim (preferito — è testo del medico; l'anonimizzazione avviene altrove, non è compito tuo), oppure (b) se ometti l'inciso, sostituiscilo con UNA sola ellissi pulita: «Il Sig. … in relazione all'incidente …». MAI lasciare l'etichetta senza il suo valore.
...
CASI SPECIALI:
- VERBALE / ACCETTAZIONE DI PRONTO SOCCORSO: si trascrive INTEGRALMENTE come ogni altro documento clinico (anamnesi, esame obiettivo, diario, consulenze, diagnosi, terapie, dimissione, prognosi). NON condensarlo: ometti solo la tabella di triage, i parametri amministrativi e le intestazioni anagrafiche RIPETUTE a sé stanti — mai spezzando una frase clinica che contiene i dati anagrafici (vale la regola di fedeltà sopra).
